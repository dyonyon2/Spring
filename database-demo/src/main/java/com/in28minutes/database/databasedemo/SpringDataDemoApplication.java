...
public class SpringDataDemoApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Inserting 10004 -> {}",repository.save(new Person("JongYoung","Suwon",new Date())));
		logger.info("Update 10003 -> {}",repository.save(new Person(10003, "Sojoong24", "dongtan",new Date())));
